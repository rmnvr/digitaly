        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div
            className={`relative p-8 rounded-2xl opacity-0 overflow-hidden
              backdrop-blur-sm shadow-lg border border-[#FF6B4A]/10
              ${isVisible ? 'animate-[fadeIn_0.6s_ease-in-out_0.3s_forwards]' : ''}`}
            style={{
              background: 'linear-gradient(135deg, rgba(255,107,74,0.1) 0%, rgba(255,138,107,0.05) 100%)'
            }}
          >
          ...
          <div
            className={`relative p-8 rounded-2xl opacity-0 overflow-hidden
              backdrop-blur-sm shadow-lg border border-[#6B2B8B]/10
              ${isVisible ? 'animate-[fadeIn_0.6s_ease-in-out_0.6s_forwards]' : ''}`}
            style={{
              background: 'linear-gradient(135deg, rgba(107,43,139,0.1) 0%, rgba(139,60,173,0.05) 100%)'
            }}
          >
            <div className="absolute inset-0 bg-white/40 backdrop-blur-sm -z-10"></div>
